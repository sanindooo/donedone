            ...
            <header class="hero-top lg:flex items-center justify-between">
                ...
                <div class="hero-content lg:w-2/5">
                    ...
                    <h1 class="hero-content--heading">
                        ...
                        Easy Help Desk Software.
                        Get Work Done.
                    </h1>

                    <p>
                        Bug tracking, task management, and
                        customer support, all in one simple
                        app your team and customers will love.
                    </p>

                    <a href="#" class="hero-content--btn btn">Get started without a credit card <span>&#8594;</span> </a>
            ...
            <footer class="hero-bottom md:mt-12">
                <div class="hero-bottom--content text-center">
                    ...
                    <div class="hero-bottom-logos flex flex-col md:flex-row flex-wrap items-center justify-center">
                        ...
                        <img class="hero-bottom-logos__item" src="img/logos/usc-logo.png">
                        <img class="hero-bottom-logos__item" src="img/logos/wieden-kennedy.png">
                        <img class="hero-bottom-logos__item" src="img/logos/teehan-lax-logo.png">
                        <img class="hero-bottom-logos__item" src="img/logos/honda-logo.png">
                    </div>
                </div>
            </footer>
            ...
            <div class="container">
                ...
                <div class="lg:flex items-center justify-between">
                    ...
                    <div class="tracking-content px-4 lg:w-1/2 lg:-mx-4">
                        ...
                        <p>
                            Use <strong> DoneDone Projects </strong> instead of messy
                            spreadsheets or bulky software for bug,
                            task, and issue tracking. No more wondering
                            where things are at or who's working on what.
                        </p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="lg:flex items-center justify-between">
                    ...
                    <div class="support-content px-4 lg:w-1/2 lg:-mx-4">
                        ...
                        <p>
                            Auto-forward company email to a <strong> DoneDone
                            Mailbox </strong> to streamline communication between
                            your support team and customers. No more headaches
                            with ccs, broken email chains, and unruly threads.
                        </p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="lg:flex items-center justify-between">
                    ...
                    <div class="workflows-content px4 lg:w-1/2 lg:-mx-4">
                        ...
                        <p>
                            DoneDone makes workflow management easy. Use our
                            time-tested <strong> bug, task tracking, customer
                            help desk, or hiring workflows </strong> or create
                            a custom workflow that fits your unique business needs.
                        </p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="lg:flex items-center justify-between">
                    ...
                    <div class="production-content px-4 lg:w-1/2 lg:-mx-4">
                        ...
                        <p>
                            DoneDone makes workflow management easy.
                            Use our time-tested <strong> bug, task tracking, customer help desk,
                            or hiring workflows </strong> or create a
                            custom workflow that fits your unique business needs.
                        </p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="lg:flex items-center justify-between">
                    ...
                    <div class="reports-content px-4 lg:w-1/2 lg:-mx-4">
                        ...
                        <p>
                            DoneDone provide answers to the <strong> important questions.</strong>
                            How quickly are we responding to support tickets? Are we keeping
                            pace with new issues? How long does it take customers to get the
                            answers they need?
                        </p>
                    </div>
                    ...
                    <div class="lg:flex md:text-left justify-between relative">
                        ...
                        <article class="testimonial lg:w-1/2 lg:-mx-4 md:flex items-start">
                            ...
                            <div class="testimonial-content">
                                ...
                                <p>
                                    "DoneDone is an excellent tool for teams with
                                    varying levels of technical knowledge. Deep enough
                                    for developers but simple enough for clients...all
                                    packaged in a clean, comfortable to use UX."
                                </p>
                        ...
                        <article class="testimonial mt-6 lg:mt-0 lg:w-1/2 lg:-mx-4 md:flex items-start">
                            ...
                            <div class="testimonial-content">
                                ...
                                <p>
                                    “I'm very pleased with DoneDone. It was
                                    the first investment I made in my business,
                                    even before Microsoft Office. It keeps me
                                    organized.”
                                </p>
    ...
    <section class="integrations mt-24 py-16 border md:border-none relative">
        ...
        <div class="container">
            ...
            <div class="text-center md:border rounded-xl md:relative md:py-16 max-w-screen-md lg:max-w-none mx-auto">
                ...
                <header class="integrations-heading">DoneDone integrates with...</header>
    ...
    <section class="mt-24">
        ...
        <div class="container">
            ...
            <div class="cta text-center max-w-screen-md mx-auto">
                ...
                <h2 class="cta-heading">Give DoneDone a try today!</h2>

                <p>
                    No credit card needed. Just sign up for a
                    free trial, invite your team, and start getting
                    things done with DoneDone.
                </p>

                <a href="#" class="cta-btn btn">Get started without a credit card <span>&#8594;</span> </a>
